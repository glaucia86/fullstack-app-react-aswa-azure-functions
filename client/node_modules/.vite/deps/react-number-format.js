...
function useNumericFormat(props) {
  ...
  var isCharacterSame = function(ref2) {
    ...
    if (value === 0 && fixedDecimalScale && decimalScale && getDecimalSeparatorIndex(currentValue) < currentValueIndex && getDecimalSeparatorIndex(formattedValue2) > formattedValueIndex) {
      return false;
    }
